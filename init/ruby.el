...
(with-eval-after-load "ruby-mode"
  ...
  ;;
  ;; RVM irb uses its own prompt pattern which does not work
  ;; properly with ruby-mode.  There are two ways to resolve this.
  ;; One is to modify ruby-mode so that it can recognize RVM prompt
  ;; pattern.  Another one is to modify $HOME/.irbrc to force RVM
  ;; irb to use the original prompt pattern.
  ;;
